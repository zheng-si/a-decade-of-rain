...
export const ECOSYSTEMS = {
  ...
  note: 'Vegetation map redrawn from the war-era U.S. land-use survey (after Westing / SIPRI). Well-documented shares: dense forest about 35% and mangrove about 36% sprayed one or more times (Westing 1971; Stellman et al. 2003, about 105,000 of 291,000\u00A0ha), plus some 200,000\u00A0ha of crop spraying, chiefly rice (NAS 1974). Types marked “est.” are not separately tabulated in the literature; their shares are estimates.',
