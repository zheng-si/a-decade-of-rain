...
export const HOTSPOTS: Hotspot[] = [
  {
    ...
    status: 'Contained',
    statusYear: '2012',
    volume: 'About 7,500\u00A0m³ isolated in an engineered landfill',
    volumeM3: 7500,
  ...
  },
  {
    ...
    status: 'Completed',
    statusYear: '2018',
    volume: 'About 90,000\u00A0m³ soil treated · 50,000\u00A0m³ contained',
    volumeM3: 140000,
    cost: 'About US$110 million',
    timeline: '2012–2018',
    method: 'In-pile thermal desorption: the soil was heated to about 335\u00A0°C to break the dioxin down',
  ...
  },
  {
    ...
    volume: 'About 500,000\u00A0m³, the largest hotspot, roughly four times Đà Nẵng',
    volumeM3: 500000,
    cost: 'About US$430 million (projected)',
    timeline: '2019–2030 (projected)',
