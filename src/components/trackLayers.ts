 ...
 *  group count lived in the config, so a fifth agent group would have given
 *  group 4 no layer to draw into and dropped its runs from the by-agent state
 *  in silence -- no error, no warning. Found while trying exactly that. */
