...
export default function ArchiveKey({
  ...
  return (
    <div className="archive-key">
      {/* The key proper, boxed so the record card below it can be a panel
          of its own on desktop while the phone still sees one sheet: the
          wrapper is `display: contents` there, and the inspect-open rule
          that hides everything but the card still has one child to hide. */}
      <div className="archive-key-card">
