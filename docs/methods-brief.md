...
Live pages: <https://rain.sizheng.me/> (the Story) and <https://rain.sizheng.me/archive> (the Atlas). Source, scripts and a longer methods note: <https://github.com/zheng-si/a-decade-of-rain>.
